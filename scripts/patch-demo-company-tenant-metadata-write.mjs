...
if (!source.includes(roundTripMarker)) {
...
for (const required of [
  ...
  `expectedTenantIdForIncomingDb(incoming, current, destination, env)`,
  `error.code = 'ATHLYRAX_DB_TENANT_IDENTITY_CONFLICT'`,
]) {
